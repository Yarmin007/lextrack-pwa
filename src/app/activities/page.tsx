...
import { 
  Plus, X, Trash2, ShoppingCart, Calculator, 
  CheckCircle2, AlertCircle, Send, Banknote, 
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 max-w-lg w-full shadow-2xl space-y-4 max-h-[85vh] flex flex-col">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-slate-50 border border-slate-200 pl-9 pr-3 py-2 rounded-xl text-xs font-semibold focus:outline-none text-slate-800"
              />
            </div>
