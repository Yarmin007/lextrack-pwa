...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#F8FAFB] text-[#364d54] font-sans flex overflow-hidden">
      
      {/* 1. SIDEBAR: Hidden by default, only shows on Large Screens (lg) */}
      ...
      <div className="flex-grow flex flex-col h-screen overflow-y-auto bg-[#F8FAFB]">
        <div className="w-full max-w-[1100px] mx-auto px-6 py-8 md:py-12 pb-32 lg:pb-12">
          ...
          <header className="flex justify-between items-center mb-10">
            <div>
              ...
              <p className="text-xs font-bold text-[#A0AEC0] uppercase tracking-widest mt-1">Tuesday, Feb 17</p>
            </div>
          ...
          {/* GRID: 1 column on mobile, 2 columns on medium, 3 columns on large */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            
            {/* Primary Balance Card - Always visible, spans 2 columns on larger screens */}
            ...
            {/* Quick Stats - Hidden on mobile, shows on md+ */}
            <div className="hidden md:flex flex-col gap-4">
              ...
              <button className="bg-[#5fa4ad] text-[#364d54] py-5 rounded-[2rem] font-black uppercase text-xs tracking-widest shadow-lg active:scale-95 transition-all">
                Add Transaction
              </button>
            </div>
          </div>

          {/* LOWER SECTION: Activity List */}
                ...
                <div key={i} className="flex justify-between items-center bg-white p-5 rounded-[2rem] border border-[#E0E7E9] shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-[#A0AEC0] font-medium uppercase">Feb 17, 2026</p>
                    </div>
                  </div>
        ...
        {/* 3. MOBILE BOTTOM NAV: Hidden on Desktop (lg) */}
